...
class Lacp(object):
    ...
    * **partner_mac**: LACP partner mac. Collected but not used. May be useful \
    ...
    def rate(self):
        ...
        """
        self._rate = None
        fileoutput = common.read_from_sys('bonding/lacp_rate', self.name)
        if fileoutput:
    ...
    def sys_priority(self):
        ...
        """
        self._sys_priority = common.read_from_sys('bonding/ad_sys_priority', self.name)
    ...
    def partner_mac(self):
        ...
        """
        self._partner_mac = common.read_from_sys('bonding/ad_partner_mac', self.name)
